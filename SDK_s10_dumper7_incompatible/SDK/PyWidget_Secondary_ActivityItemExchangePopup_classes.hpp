...
public:
	...
	TSubclassOf<class UPyWidget_Secondary_ActivityItemExchangeJumpPathItem> JumpItemWidget;          // 0x05F8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FUIActionData>                  ItemUIActionDataList;                              // 0x0600(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NativeAccessSpecifierPublic)
