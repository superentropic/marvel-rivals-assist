...
// 0x0060 (0x2AF0 - 0x2A90)
#pragma pack(push, 0x1)
class SDK_ALIGN(0x10) APyMarvelPlayerController : public AMarvelPlayerController
{
public:
	class APyMarvelAIController*                  ClientAIController;                                // 0x2A90(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInputMappingContext*                   AbilityActionMappingContextBP;                     // 0x2A98(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInputMappingContext*                   OneSubmitActionMappingContextBP;                   // 0x2AA0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class FString& key, const class FString& json_str)> OnClientReceiveJson; // 0x2AA8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class AActor* npc_actor)> OnLevelNPCVoice;                         // 0x2AB8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnClientStartReplaySuccess;                        // 0x2AC8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class FString& session_name, float current_replay_time)> OnServerSyncReplayTime; // 0x2AD8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
public:
	...
	void ReqSetSpawnSelectPhase();
	void ReqSelectSpawnAndRespawn(class APyPlayerStart* player_start);
	...
	void OnCrossTravelData(int32 HeroId, int32 SkinId, const struct FVector& Location, const struct FRotator& Rotation, const class FString& SculptTagName, int32 HeroRole, bool bIsAck);
	void C_OnClientCrossSetData(int32 HeroId, int32 SkinID, const struct FVector& location, const struct FRotator& rotation, const struct FGameplayTag& sculpt_tag, EHeroRole hero_role, bool use_last_transform);
	...
	void C_OnClientPackageTag(const class FString& tag);
	void ServerRPC_StartEmoteStress(int32 EmoteId, bool IncludeSelf, float RoundDuration, int32 Rounds, int32 Seed);
	void ServerRPC_StopEmoteStress();
	void ClientRPC_AssignEmoteStressGroup(const class FString& GroupId, const class FString& Role_0, int32 PartnerUid, int32 EmoteId);
	void ClientRPC_ClearEmoteStressGroup();
