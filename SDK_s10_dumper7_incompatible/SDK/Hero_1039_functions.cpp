...
void UCueCombineBeamPoolComponent_103951::AddOrRefreshBeam(class AActor* Target)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CueCombineBeamPoolComponent_103951", "AddOrRefreshBeam");

	Params::CueCombineBeamPoolComponent_103951_AddOrRefreshBeam Parms{};
...
// Function Hero_1039.CueCombineBeamPoolComponent_103951.RemoveAllBeams
// (Final, Native, Public, BlueprintCallable)

void UCueCombineBeamPoolComponent_103951::RemoveAllBeams()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CueCombineBeamPoolComponent_103951", "RemoveAllBeams");
...
void UCueCombineBeamPoolComponent_103951::SetInstigator(class AActor* InInstigator)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CueCombineBeamPoolComponent_103951", "SetInstigator");

	Params::CueCombineBeamPoolComponent_103951_SetInstigator Parms{};
