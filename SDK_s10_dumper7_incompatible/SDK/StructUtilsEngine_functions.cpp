...
// Parameters:
// EStructUtilsResult*                     ExecResult                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FSharedStruct&             SharedStruct                                           (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// int32*                                  Value                                                  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UStructUtilsFunctionLibrary::GetSharedStructValue(EStructUtilsResult* ExecResult, const struct FSharedStruct& SharedStruct, int32* Value)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("StructUtilsFunctionLibrary", "GetSharedStructValue");

	Params::StructUtilsFunctionLibrary_GetSharedStructValue Parms{};

	Parms.SharedStruct = std::move(SharedStruct);
...
EStructUtilsResult UStructUtilsFunctionLibrary::IsSharedStructValid(const struct FSharedStruct& SharedStruct)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("StructUtilsFunctionLibrary", "IsSharedStructValid");

	Params::StructUtilsFunctionLibrary_IsSharedStructValid Parms{};
...
bool UStructUtilsFunctionLibrary::IsValid_SharedStruct(const struct FSharedStruct& SharedStruct)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("StructUtilsFunctionLibrary", "IsValid_SharedStruct");

	Params::StructUtilsFunctionLibrary_IsValid_SharedStruct Parms{};
...
// Parameters:
// const int32&                            Value                                                  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FSharedStruct                    ReturnValue                                            (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct FSharedStruct UStructUtilsFunctionLibrary::MakeSharedStruct(const int32& Value)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("StructUtilsFunctionLibrary", "MakeSharedStruct");

	Params::StructUtilsFunctionLibrary_MakeSharedStruct Parms{};
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct FSharedStruct&                   SharedStruct                                           (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UStructUtilsFunctionLibrary::ResetSharedStruct(struct FSharedStruct& SharedStruct)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("StructUtilsFunctionLibrary", "ResetSharedStruct");

	Params::StructUtilsFunctionLibrary_ResetSharedStruct Parms{};
	...
	SharedStruct = std::move(Parms.SharedStruct);
}
...
void UStructUtilsFunctionLibrary::SetSharedStructValue(struct FSharedStruct& SharedStruct, const int32& Value)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("StructUtilsFunctionLibrary", "SetSharedStructValue");

	Params::StructUtilsFunctionLibrary_SetSharedStructValue Parms{};
