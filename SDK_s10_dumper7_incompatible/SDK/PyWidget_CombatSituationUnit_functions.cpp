...
void UPyWidget_CombatSituationPanel::OnCharRegister(class AActor* Char)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CombatSituationPanel", "OnCharRegister");

	Params::PyWidget_CombatSituationPanel_OnCharRegister Parms{};
...
// (Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// const struct FKillFeedCrossTierPayload& payload                                                (ConstParm, Parm, OutParm, ReferenceParm)

void UPyWidget_CombatSituationPanel::OnKillFeedFallback(const struct FKillFeedCrossTierPayload& payload)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CombatSituationPanel", "OnKillFeedFallback");

	Params::PyWidget_CombatSituationPanel_OnKillFeedFallback Parms{};
...
// (Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// const struct FRebornCrossTierPayload&   payload                                                (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor)

void UPyWidget_CombatSituationPanel::OnRebornFeedFallback(const struct FRebornCrossTierPayload& payload)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CombatSituationPanel", "OnRebornFeedFallback");

	Params::PyWidget_CombatSituationPanel_OnRebornFeedFallback Parms{};
