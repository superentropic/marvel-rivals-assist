...
void UPyMarvelGameInstance::EnableDeathReplayClientDataVersionOpt(bool is_enable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyMarvelGameInstance", "EnableDeathReplayClientDataVersionOpt");

	Params::PyMarvelGameInstance_EnableDeathReplayClientDataVersionOpt Parms{};
...
// PythonFunction PyMarvelGameInstance.PyMarvelGameInstance.SyncCrossTravelCacheBeforeAck
// (Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyMarvelGameInstance::SyncCrossTravelCacheBeforeAck()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyMarvelGameInstance", "SyncCrossTravelCacheBeforeAck");
