...
void UAkComponent::SetOutputBusVolume(float BusVolume, bool bForce)
{
	static class UFunction* Func = nullptr;
...
float UAkComponent::GetOutputBusVolume() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AkComponent", "GetOutputBusVolume");

	Params::AkComponent_GetOutputBusVolume Parms{};
...
bool UAkGameplayStatics::SeekGlobal(int32 PlayingID, int32 TimeMs)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AkGameplayStatics", "SeekGlobal");

	Params::AkGameplayStatics_SeekGlobal Parms{};
