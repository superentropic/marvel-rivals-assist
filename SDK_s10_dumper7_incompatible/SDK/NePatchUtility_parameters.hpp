...
DUMPER7_ASSERTS_NePatchUtility_GetMountedPakNames;
...
// 0x0020 (0x0020 - 0x0000)
struct NePatchUtility_GetUtocEntryInfos final
{
public:
	class FString                                 TocFilePath;                                       // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FNePatchUtocEntryInfo>          ReturnValue;                                       // 0x0010(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_NePatchUtility_GetUtocEntryInfos;
