...
// PythonFunction PyWidget_HpBar.PyWidget_HpBar_V3.SetShieldTreatColor
// (Native, Event, Protected, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FLinearColor&              Color                                                  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UPyWidget_HpBar_V3::SetShieldTreatColor(const struct FLinearColor& Color)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_HpBar_V3", "SetShieldTreatColor");

	Params::PyWidget_HpBar_V3_SetShieldTreatColor Parms{};
...
// PythonFunction PyWidget_HpBar.PyWidget_BattleHpBar_V3.Destruct
// (BlueprintCosmetic, Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyWidget_BattleHpBar_V3::Destruct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_BattleHpBar_V3", "Destruct");
