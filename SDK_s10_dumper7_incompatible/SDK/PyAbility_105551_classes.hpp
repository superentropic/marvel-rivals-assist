...
{
public:
	TMap<int32, float>                            DifferentApplyDamageToPer;                         // 0x1D88(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
{
public:
	class UNiagaraSystem*                         NS_Release;                                        // 0x01B8(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AttachedSocketName;                                // 0x01C0(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DelayDeactivateTime;                               // 0x01D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
