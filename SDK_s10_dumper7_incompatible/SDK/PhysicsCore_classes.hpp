...
// The generated Engine and PhysicsCore headers include each other. Keeping the
// concrete size here breaks that cycle without changing any referenced fields.
