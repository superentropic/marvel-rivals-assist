...
bool ASVONVolume::FindPathPointsBetweenPos(const struct FVector& StartPos, const struct FVector& TargetPos, const struct FSVONPathFinderSettings& PathFinderSettings, TArray<struct FVector>* OutPathPoints)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SVONVolume", "FindPathPointsBetweenPos");

	Params::SVONVolume_FindPathPointsBetweenPos Parms{};
