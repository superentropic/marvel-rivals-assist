...
// Parameters:
// const int32                             UID                                                    (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UObject*                          Handler                                                (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UNiagaraDataInterfaceCombineTriggerFX::SetUniqueInstanceCallbackHandler(const int32 UID, class UObject* Handler)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraDataInterfaceCombineTriggerFX", "SetUniqueInstanceCallbackHandler");

	Params::NiagaraDataInterfaceCombineTriggerFX_SetUniqueInstanceCallbackHandler Parms{};
