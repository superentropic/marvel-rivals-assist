...
// PythonFunction PyWidget_WeaponStatus.PyUIC_TagDrivenInfinite.OnInit
// (Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyUIC_TagDrivenInfinite::OnInit()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyUIC_TagDrivenInfinite", "OnInit");
...
// PythonFunction PyWidget_WeaponStatus.PyUIC_TagDrivenInfinite.OnDestruct
// (Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyUIC_TagDrivenInfinite::OnDestruct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyUIC_TagDrivenInfinite", "OnDestruct");
