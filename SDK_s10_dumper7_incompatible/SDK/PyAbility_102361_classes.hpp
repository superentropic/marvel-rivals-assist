...
// 0x0020 (0x31E0 - 0x31C0)
class UPyConfig_102361 final : public UConfig_102361
{
public:
	struct FVector                                CapsuleLocationOffset;                             // 0x31C0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LaunchVerticalVelocity;                            // 0x31D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LaunchHorizontalVelocity;                          // 0x31DC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
