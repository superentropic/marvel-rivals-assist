...
void UPyWidget_Squad_MainPanel::OnCascadingVisibleChanged(bool bNewVisible)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_Squad_MainPanel", "OnCascadingVisibleChanged");

	Params::PyWidget_Squad_MainPanel_OnCascadingVisibleChanged Parms{};
