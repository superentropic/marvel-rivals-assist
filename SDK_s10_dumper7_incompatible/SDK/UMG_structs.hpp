...
// Enum UMG.EUITexturePrepareStatus
// NumValues: 0x0007
enum class EUITexturePrepareStatus : uint8
{
	Invalid                                  = 0,
	Pending                                  = 1,
	Ready                                    = 2,
	...
	Cancelled                                = 4,
	Stale                                    = 5,
	EUITexturePrepareStatus_MAX              = 6,
};

// Enum UMG.EUITextureCaptureStatus
// NumValues: 0x0007
enum class EUITextureCaptureStatus : uint8
{
	Invalid                                  = 0,
	Pending                                  = 1,
	Ready                                    = 2,
...
public:
	...
	class FName                                   ActivityID;                                        // 0x00E0(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SystemRuleID;                                      // 0x00EC(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
