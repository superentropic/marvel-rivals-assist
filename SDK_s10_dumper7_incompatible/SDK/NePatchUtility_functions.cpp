...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable)
// Parameters:
// TArray<class FString>*                  PakFilenames                                           (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)

void UNePatchUtility::GetMountedPakNames(TArray<class FString>* PakFilenames)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("NePatchUtility", "GetMountedPakNames");

	Params::NePatchUtility_GetMountedPakNames Parms{};
	...
	if (PakFilenames != nullptr)
		*PakFilenames = std::move(Parms.PakFilenames);
}
...
// Function NePatchUtility.NePatchUtility.GetUtocEntryInfos
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// const class FString&                    TocFilePath                                            (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<struct FNePatchUtocEntryInfo>    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)

TArray<struct FNePatchUtocEntryInfo> UNePatchUtility::GetUtocEntryInfos(const class FString& TocFilePath)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("NePatchUtility", "GetUtocEntryInfos");

	Params::NePatchUtility_GetUtocEntryInfos Parms{};
