...
// Function DLSSBlueprint.DLSSLibrary.GetDLSSModeScreenPercentage
// (Final, RequiredAPI, Native, Static, Public, BlueprintCallable, BlueprintPure)
// Parameters:
// EUDLSSMode                              DLSSMode                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

float UDLSSLibrary::GetDLSSModeScreenPercentage(EUDLSSMode DLSSMode)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("DLSSLibrary", "GetDLSSModeScreenPercentage");

	Params::DLSSLibrary_GetDLSSModeScreenPercentage Parms{};
