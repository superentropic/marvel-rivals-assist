...
// (Final, Native, Public)
// Parameters:
// const struct FShadowMesh&               ShadowMeshComponent                                    (Parm, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
// Function Hero_1043.Ability_104342.ResetConfigAndSelectTask
// (Final, Native, Public, BlueprintCallable)

void UAbility_104342::ResetConfigAndSelectTask()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ability_104342", "ResetConfigAndSelectTask");
...
// const TArray<struct FMaterialTag>&      MaterialTagArray                                       (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
// bool                                    NewState                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ACue_Ability_Loop_10434101::SetMaterialChangeTimer(float ChangeTime, TArray<class FName>* MaterialSlotNameArray, const TArray<struct FMaterialTag>& MaterialTagArray, bool NewState)
{
	static class UFunction* Func = nullptr;
	...
	Parms.MaterialTagArray = std::move(MaterialTagArray);
...
void ACue_Ability_Loop_10434101::SetMeshMaterials(TArray<class FName>* MaterialSlotNameArray, const TArray<struct FMaterialTag>& MaterialTagArray, bool NewState)
{
	static class UFunction* Func = nullptr;
...
// Function Hero_1043.Cue_TraceActor_10439501.UpdateRotation
// (Final, Native, Public)

void ACue_TraceActor_10439501::UpdateRotation()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Cue_TraceActor_10439501", "UpdateRotation");
