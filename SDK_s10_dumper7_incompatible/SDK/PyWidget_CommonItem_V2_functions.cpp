...
void UPyWidget_CommonItem::SetEnableRightClick(bool IsEnableRightClick_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CommonItem", "SetEnableRightClick");

	Params::PyWidget_CommonItem_SetEnableRightClick Parms{};
...
void UPyWidget_CommonItem::SetIsNeedRightClickPreview(bool is_need)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CommonItem", "SetIsNeedRightClickPreview");

	Params::PyWidget_CommonItem_SetIsNeedRightClickPreview Parms{};
...
// (Native, Public, BlueprintCallable)
// Parameters:
// bool                                    IsImgMeanwhileVisible_0                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UPyWidget_CommonItem::SetIsImgMeanwhileVisible(bool IsImgMeanwhileVisible_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CommonItem", "SetIsImgMeanwhileVisible");

	Params::PyWidget_CommonItem_SetIsImgMeanwhileVisible Parms{};

	Parms.IsImgMeanwhileVisible_0 = IsImgMeanwhileVisible_0;
