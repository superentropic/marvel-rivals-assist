...
{
public:
	float                                         AnimDelayTime;                                     // 0x07B0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateColor                            Color_InRank;                                      // 0x07B4(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            Color_NotInRank;                                   // 0x07C8(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
