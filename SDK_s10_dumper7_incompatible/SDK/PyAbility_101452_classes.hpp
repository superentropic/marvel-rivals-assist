...
{
public:
	TArray<class AActor*>                         SweepIgnoreActors;                                 // 0x0C20(0x0010)(NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnSlideStateChanged;                               // 0x0C30(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
