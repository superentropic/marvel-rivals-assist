...
{
public:
	struct FLinearColor                           BgColor;                                           // 0x07B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FKeyWidgetStyle                        BtnKeyWidgetStyle;                                 // 0x07C0(0x00D4)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
