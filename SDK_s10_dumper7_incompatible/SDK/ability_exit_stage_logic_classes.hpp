...
class UPyAIAbilityExitStage_CanNotSeeTarget : public UPyAIAbilityExitStageLogicBase
{
public:
...
public:
	...
	struct FGameplayTag                           AmmoTag;                                           // 0x003C(0x000C)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          InverseResult;                                     // 0x0048(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UPyAIAbilityExitStage_CheckTeammateAroundFullHealth final : public UPyAIAbilityExitStageLogicBase
{
public:
