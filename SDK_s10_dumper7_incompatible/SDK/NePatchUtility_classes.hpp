...
public:
	...
	static void GetMountedPakNames(TArray<class FString>* PakFilenames);
	...
	static TArray<struct FNePatchUtocEntryInfo> GetUtocEntryInfos(const class FString& TocFilePath);
