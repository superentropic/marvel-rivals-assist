...
{
public:
	class USummonedAbilitySystemComponent*        AbilitySystemComponent;                            // 0x1540(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
