...
{
public:
	class APyLevelPortalBase*                     CurrentPortalBase;                                 // 0x3448(0x0008)(Net, ZeroConstructor, Transient, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class APyLevelPortalBase* Last, class APyLevelPortalBase* Current)> CurrentPortalChanged; // 0x3450(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
