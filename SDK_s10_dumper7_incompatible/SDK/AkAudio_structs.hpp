...
// ScriptStruct AkAudio.AkMidiEventLoopSlots
// 0x0050 (0x0050 - 0x0000)
struct FAkMidiEventLoopSlots final
{
public:
	TMap<int32, class UAkMidiEventLoop*>          Loops;                                             // 0x0000(0x0050)(Transient, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_FAkMidiEventLoopSlots;
