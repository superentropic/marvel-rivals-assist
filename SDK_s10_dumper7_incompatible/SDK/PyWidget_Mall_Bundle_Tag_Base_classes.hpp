...
class SDK_ALIGN(0x08) UPyWidget_Mall_Bundle_Tag_Base : public UPyMarvelUserWidget
{
public:
	void Construct();
	void Destruct();
...
public:
	...
	struct FSlateFontInfo                         TextFont;                                          // 0x05F8(0x0068)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateColor                            TextColor;                                         // 0x0660(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_5F2[0x6];                                      // 0x05F2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UTexture2D*                             Texture_BG;                                        // 0x05F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateColor                            NormalColor_BG;                                    // 0x0600(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	int32                                         PreviewTimestamp;                                  // 0x05F4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PreviewFormatType;                                 // 0x05F8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class FString                                 DefaultFormatText;                                 // 0x0618(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
