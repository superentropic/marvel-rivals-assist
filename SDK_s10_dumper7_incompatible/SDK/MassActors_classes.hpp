...
public:
	...
	TMap<struct FMassNetworkID, class UMassAgentComponent*> ReplayReplicatedAgentComponents;         // 0x0158(0x0050)(ExportObject, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
