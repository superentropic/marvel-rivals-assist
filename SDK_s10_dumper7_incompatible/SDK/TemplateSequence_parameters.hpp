...
public:
	...
	struct FMinimalViewInfo                       ReturnValue;                                       // 0x0010(0x0A70)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FPostProcessSettings                   OutPPSettings;                                     // 0x0010(0x0990)(Parm, OutParm, NativeAccessSpecifierPublic)
	float                                         OutPPBlendWeight;                                  // 0x09A0(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x09A4(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
