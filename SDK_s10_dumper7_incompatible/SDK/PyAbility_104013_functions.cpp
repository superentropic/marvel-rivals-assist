...
void UPyEffectiveComponent_10401301::K2_OnPreApplyContainerV2(const struct FSharedStruct& MutableHitResultsHolder)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyEffectiveComponent_10401301", "K2_OnPreApplyContainerV2");

	Params::PyEffectiveComponent_10401301_K2_OnPreApplyContainerV2 Parms{};
