...
// 0x0010 (0x0010 - 0x0000)
struct EnhancedInputSubsystemInterface_AddChordPrecedenceRule final
{
public:
	class UInputMappingContext*                   SourceIMC;                                         // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UInputMappingContext*                   PriorityIMC;                                       // 0x0008(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_EnhancedInputSubsystemInterface_AddChordPrecedenceRule;
...
// 0x0008 (0x0008 - 0x0000)
struct EnhancedInputSubsystemInterface_RemoveChordPrecedenceRule final
{
public:
	const class UInputMappingContext*             SourceIMC;                                         // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_EnhancedInputSubsystemInterface_RemoveChordPrecedenceRule;
