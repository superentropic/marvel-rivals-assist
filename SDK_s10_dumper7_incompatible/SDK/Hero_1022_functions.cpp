...
void AMarvelCueNotify_CaptainShadow::OnViewTargetChange(class AActor* ViewingTarget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MarvelCueNotify_CaptainShadow", "OnViewTargetChange");

	Params::MarvelCueNotify_CaptainShadow_OnViewTargetChange Parms{};
...
// const struct FActiveGameplayEffect&     AGE                                                    (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
