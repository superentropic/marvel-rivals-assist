...
void UPyAbility_102235::OnCharacterReborn(class AActor* TargetActor, const struct FCharacterRebornParam& Param)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyAbility_102235", "OnCharacterReborn");

	Params::PyAbility_102235_OnCharacterReborn Parms{};
