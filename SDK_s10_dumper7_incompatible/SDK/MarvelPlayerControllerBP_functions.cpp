...
// Parameters:
// const class FString&                    Message_ShowMessageToChatPanelWithType                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
// int32                                   Type_ShowMessageToChatPanelWithType                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AMarvelPlayerControllerBP_C::ShowMessageToChatPanelWithType(const class FString& Message_ShowMessageToChatPanelWithType, int32 Type_ShowMessageToChatPanelWithType)
{
	...
	Parms.Message_ShowMessageToChatPanelWithType = std::move(Message_ShowMessageToChatPanelWithType);
	Parms.Type_ShowMessageToChatPanelWithType = Type_ShowMessageToChatPanelWithType;
...
// (Event, Public, BlueprintEvent)
// Parameters:
// const class FString&                    Message_ShowMessageToChatPanel                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)

void AMarvelPlayerControllerBP_C::ShowMessageToChatPanel(const class FString& Message_ShowMessageToChatPanel)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Message_ShowMessageToChatPanel = std::move(Message_ShowMessageToChatPanel);
...
// (Event, Public, BlueprintEvent)
// Parameters:
// const class FString&                    Command_SendCmdToPython                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)

void AMarvelPlayerControllerBP_C::SendCmdToPython(const class FString& Command_SendCmdToPython)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Command_SendCmdToPython = std::move(Command_SendCmdToPython);
