...
// const struct FMarvelPVE_EffectSpec&     EffectSpec                                             (ConstParm, Parm, OutParm, ReferenceParm)
// const struct FMarvelPVE_ActiveEffectHandle&Handle                                                 (ConstParm, Parm, OutParm, ReferenceParm)

void UPyUICUnit_SummonNum::OnTargetActorEffectApplied(class AMarvelBaseCharacter* Character, const struct FMarvelPVE_EffectSpec& EffectSpec, const struct FMarvelPVE_ActiveEffectHandle& Handle)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyUICUnit_SummonNum", "OnTargetActorEffectApplied");

	Params::PyUICUnit_SummonNum_OnTargetActorEffectApplied Parms{};
