...
// PythonFunction PyMisterFantasticCharacter.PyMisterFantasticCharacter.ForceResetToDefaultState
// (Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void APyMisterFantasticCharacter::ForceResetToDefaultState()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyMisterFantasticCharacter", "ForceResetToDefaultState");
