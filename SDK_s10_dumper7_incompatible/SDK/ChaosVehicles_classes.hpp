...
public:
	...
	float                                         VehicleSimScale;                                   // 0x0200(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableCenterOfMassOverride;                       // 0x0204(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	void SetVehicleSimScale(float InVehicleSimScale);
	...
	float GetVehicleSimScale() const;
	bool IsParked() const;
...
public:
	...
	bool                                          bStepAssistEnabled;                                // 0x09D3(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StepAssistMaxHeight;                               // 0x09D4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StepAssistProbeDistance;                           // 0x09D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StepAssistProbeRadius;                             // 0x09DC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StepAssistAcceleration;                            // 0x09E0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StepAssistImpulseVelocity;                         // 0x09E4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StepAssistMaxSpeedKmh;                             // 0x09E8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StepAssistMinSpeedScale;                           // 0x09EC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStepClimbEnabled;                                 // 0x09F0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9F1[0x3];                                      // 0x09F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StepClimbMaxHeight;                                // 0x09F4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StepClimbClearanceScale;                           // 0x09F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StepClimbWalkableSlopeAngle;                       // 0x09FC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FChaosWheelSetup>               WheelSetups;                                       // 0x0A00(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FCollisionResponseContainer            WheelTraceCollisionResponses;                      // 0x0A10(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bMechanicalSimEnabled;                             // 0x0A30(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A31[0x7];                                      // 0x0A31(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVehicleEngineConfig                   EngineSetup;                                       // 0x0A38(0x00C8)(Edit, NativeAccessSpecifierPublic)
	...
	struct FVehicleSteeringConfig                 SteeringSetup;                                     // 0x0B80(0x00D8)(Edit, NativeAccessSpecifierPublic)
	bool                                          bScaleSteeringAngleWithVehicleSimScale;            // 0x0C58(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C59[0x7];                                      // 0x0C59(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UChaosVehicleWheel*>             Wheels;                                            // 0x0C60(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DuplicateTransient, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_C70[0xB80];                                    // 0x0C70(0x0B80)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ClientReceiveClientStateDrivenBaseline(const struct FChaosVehicleEpochBaseline& Baseline);
	void ClientReceiveClientStateDrivenCorrection(const struct FChaosVehicleClientStateCorrection& Correction);
	void ClientSetClientStateDrivenAuthorityEnabled(bool bEnabled, uint32 AuthorityEpoch);
	void EnableMechanicalSim(bool InState);
	void EnableSuspension(bool InState);
	void EnableWheelFriction(bool InState);
	void ServerAcknowledgeClientStateDrivenEpoch(const struct FChaosVehicleEpochAcknowledgement& Acknowledgement);
	void ServerRequestClientStateDrivenRecovery(uint32 AuthorityEpoch);
	void ServerSubmitClientStateDrivenInterval(const struct FChaosVehicleClientStateInterval& Interval);
	...
	struct FChaosVehicleClientStateDrivenDiagnostics GetClientStateDrivenDiagnostics() const;
...
// 0x0890 (0x0ED0 - 0x0640)
class UVehicleAnimationInstance final : public UAnimInstance
{
public:
	uint8                                         Pad_640[0x880];                                    // 0x0640(0x0880)(Fixing Size After Last Property [ Dumper-7 ])
	class UChaosWheeledVehicleMovementComponent*  WheeledVehicleComponent;                           // 0x0EC0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
class SDK_ALIGN(0x10) AWheeledVehiclePawn : public APawn
{
public:
	...
	bool                                          bApplySpringArmScaleOverrides;                     // 0x07B0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7B1[0x3];                                      // 0x07B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SpringArmScaleOverrideTolerance;                   // 0x07B4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FVehicleSpringArmScaleOverride> SpringArmScaleOverrides;                           // 0x07B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)

public:
	bool ApplySpringArmScaleOverride(float InVehicleSimScale);
	void ApplySpringArmScaleOverrides();
