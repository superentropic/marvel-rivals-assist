...
// Function Hero_1026.TraceComponent_10261101.OnTraceResultV2
// (Final, Native, Public)
// Parameters:
// class UObject*                          TraceSource                                            (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FSharedStruct&             ReadOnlyHitResultsHolder                               (Parm, NativeAccessSpecifierPublic)

void UTraceComponent_10261101::OnTraceResultV2(class UObject* TraceSource, const struct FSharedStruct& ReadOnlyHitResultsHolder)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TraceComponent_10261101", "OnTraceResultV2");

	Params::TraceComponent_10261101_OnTraceResultV2 Parms{};
...
void UAbility_102641::OnAbilityHit(class UGameplayAbility* InAbility, const struct FMarvelAbilityHitParams& HitParams, const struct FSharedStruct& ReadOnlyHitResultsHolder)
{
	static class UFunction* Func = nullptr;
