...
// PythonFunction PyControl.PyAttachedPlayerStartComponent.ReceiveInitializeComponent
// (Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyAttachedPlayerStartComponent::ReceiveInitializeComponent()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyAttachedPlayerStartComponent", "ReceiveInitializeComponent");
