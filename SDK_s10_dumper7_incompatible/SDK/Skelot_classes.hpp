...
{
public:
	int32                                         InstanceIndex;                                     // 0x0DE0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class USkelotCharacterSyncComponent> SkelotComponent;                             // 0x0DE4(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_910[0x20C];                                    // 0x0910(0x020C)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         TransitionBudgetLimit;                             // 0x0B1C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B20[0x10];                                     // 0x0B20(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class USkelotComponent* Component, const TArray<struct FSkelotAnimFinishEvent>& Events)> OnAnimationFinishedDelegate; // 0x0B30(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class USkelotComponent* Component, const TArray<struct FSkelotAnimNotifyEvent>& Events)> OnAnimationNotifyDelegate; // 0x0B40(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMap<int32, struct FSkelotDynInsTieData>      DynamicPoseInstancesTiedToSMC;                     // 0x0B50(0x0050)(BlueprintVisible, BlueprintReadOnly, Transient, ContainsInstancedReference, NativeAccessSpecifierPublic)
	uint8                                         Pad_BA0[0x70];                                     // 0x0BA0(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool InstanceBlend1DSetValue(int32 InstanceIndex, float InX, float InY, bool bLoop);
	...
	void SetInstanceTeamOutlineStencil(int32 InstanceIndex, int32 Stencil);
	...
	bool IsInstancePlayingBlend1D(int32 InstanceIndex, class UBlendSpace* InBlend1DAsset) const;
...
{
public:
	struct FTransform3f                           MeshTransform;                                     // 0x0C10(0x0030)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C40[0x10];                                     // 0x0C40(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
class SDK_ALIGN(0x10) USkelotAnimCollection : public UDataAsset
{
public:
	...
	bool                                          bEnableEditorSequences;                            // 0x0059(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_1A1[0x537];                                    // 0x01A1(0x0537)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         NumTransitionFrameAllocated;                       // 0x06D8(0x0004)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6DC[0x1C];                                     // 0x06DC(0x001C)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void DumpTransitionData(bool ReleaseTransition);
...
class ISkelotListenerInterface final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
