...
// Function FieldSystemEngine.SectorFalloff.SetSectorFalloff
// (Final, Native, Public, HasDefaults, BlueprintCallable, BlueprintPure)
// Parameters:
// float                                   Magnitude_0                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   MinRange_0                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   MaxRange_0                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   Default_0                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   SectorRadius_0                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   SectorHalfHeight_0                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   SectorAngle_0                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FTransform&                Transform_0                                            (Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EFieldFalloffType                       Falloff_0                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class USectorFalloff*                   ReturnValue                                            (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class USectorFalloff* USectorFalloff::SetSectorFalloff(float Magnitude_0, float MinRange_0, float MaxRange_0, float Default_0, float SectorRadius_0, float SectorHalfHeight_0, float SectorAngle_0, const struct FTransform& Transform_0, EFieldFalloffType Falloff_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SectorFalloff", "SetSectorFalloff");

	Params::SectorFalloff_SetSectorFalloff Parms{};

	Parms.Magnitude_0 = Magnitude_0;
	Parms.MinRange_0 = MinRange_0;
	Parms.MaxRange_0 = MaxRange_0;
	Parms.Default_0 = Default_0;
	Parms.SectorRadius_0 = SectorRadius_0;
	Parms.SectorHalfHeight_0 = SectorHalfHeight_0;
	Parms.SectorAngle_0 = SectorAngle_0;
	Parms.Transform_0 = std::move(Transform_0);
	Parms.Falloff_0 = Falloff_0;
