...
int32 UMarvelBackTrackAbility::GetPathDatasNum() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MarvelBackTrackAbility", "GetPathDatasNum");

	Params::MarvelBackTrackAbility_GetPathDatasNum Parms{};
...
void UBuffManagerAbility_100009::OnOwnerTagChanged(const struct FGameplayTag& Tag, int32 NewCount)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BuffManagerAbility_100009", "OnOwnerTagChanged");

	Params::BuffManagerAbility_100009_OnOwnerTagChanged Parms{};
...
bool UAbility_100015::IsBondActive(int32 InBondID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ability_100015", "IsBondActive");

	Params::Ability_100015_IsBondActive Parms{};
...
// Function Hero_Synergy.Ability_100015.K2_OnWavingAbilityCancelled
// (Native, Event, Protected, BlueprintEvent)

void UAbility_100015::K2_OnWavingAbilityCancelled()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ability_100015", "K2_OnWavingAbilityCancelled");
...
void UAbility_100015::OnCancelWavingTagActivated(const struct FGameplayTag& InTag, bool bTagExists)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ability_100015", "OnCancelWavingTagActivated");

	Params::Ability_100015_OnCancelWavingTagActivated Parms{};
