...
// const TArray<class AActor*>&            Ignores                                                (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
// struct FHitResult*                      OutHitResult                                           (Parm, OutParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
// bool                                    bCheckBlockingVolume                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UAbility_104661::CheckSceneBlockBySphereTrace(class UObject* WorldContextObject, const struct FVector& Start, const struct FVector& End, float Radius, const TArray<class AActor*>& Ignores, struct FHitResult* OutHitResult, bool bCheckBlockingVolume)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("Ability_104661", "CheckSceneBlockBySphereTrace");

	Params::Ability_104661_CheckSceneBlockBySphereTrace Parms{};

	Parms.WorldContextObject = WorldContextObject;
	Parms.Start = std::move(Start);
	Parms.End = std::move(End);
	Parms.Radius = Radius;
	Parms.Ignores = std::move(Ignores);
	Parms.bCheckBlockingVolume = bCheckBlockingVolume;
...
bool UAbility_104661::IsSummonerUnderDeathZone(const struct FVector& InStart, const struct FVector& InEnd, float InRadius) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ability_104661", "IsSummonerUnderDeathZone");

	Params::Ability_104661_IsSummonerUnderDeathZone Parms{};
