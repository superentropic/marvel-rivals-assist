...
{
public:
	TMulticastInlineDelegate<void(bool IsHidden)> DelegateOnHidePhantomWhenTeleport;                 // 0x1580(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
{
public:
	class ASummonedCharacterBase*                 PhantomCharacter;                                  // 0x2BB0(0x0008)(BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class UNiagaraSystem*                         CollabrateReleaseFX;                               // 0x13A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
