...
public:
	...
	TSubclassOf<class UPyWidget_League_ScheduleOverview_DoubleElimination_StartUpRound> StartNumber; // 0x05D8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UPyWidget_League_ScheduleOverview_Elimination_OddNumber> OddNumber;            // 0x05E0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UPyWidget_League_ScheduleOverview_DoubleElimination_EvenNumber> EvenNumber;    // 0x05E8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
