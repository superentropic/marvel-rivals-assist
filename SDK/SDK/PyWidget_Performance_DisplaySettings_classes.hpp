...
{
public:
	struct FSlateColor                            Color_High;                                        // 0x0740(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            Color_Mid;                                         // 0x0754(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            Color_Low;                                         // 0x0768(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            Color_Default;                                     // 0x077C(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	struct FSlateColor                            Text_Title_Color;                                  // 0x05D4(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            Text_Value_Color;                                  // 0x05E8(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
