...
// PythonFunction PyLevelSequenceActor.PyLevelSequenceActor.PauseSequence
// (Native, Public, BlueprintCallable)

void APyLevelSequenceActor::PauseSequence()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyLevelSequenceActor", "PauseSequence");
