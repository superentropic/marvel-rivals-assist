...
// PythonFunction PyWidget_NameplateModel.PyWidget_NameplateModel.OnInitialized
// (BlueprintCosmetic, Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyWidget_NameplateModel::OnInitialized()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_NameplateModel", "OnInitialized");
