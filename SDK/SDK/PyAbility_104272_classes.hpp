...
{
public:
	TMulticastInlineDelegate<void()>              OnShowCoolDownUI;                                  // 0x2B40(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
