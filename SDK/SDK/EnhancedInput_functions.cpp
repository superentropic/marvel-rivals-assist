...
// Function EnhancedInput.EnhancedInputSubsystemInterface.AddChordPrecedenceRule
// (BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
// class UInputMappingContext*             SourceIMC                                              (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UInputMappingContext*             PriorityIMC                                            (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void IEnhancedInputSubsystemInterface::AddChordPrecedenceRule(class UInputMappingContext* SourceIMC, class UInputMappingContext* PriorityIMC)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("EnhancedInputSubsystemInterface", "AddChordPrecedenceRule");

	Params::EnhancedInputSubsystemInterface_AddChordPrecedenceRule Parms{};

	Parms.SourceIMC = SourceIMC;
	Parms.PriorityIMC = PriorityIMC;
...
// Function EnhancedInput.EnhancedInputSubsystemInterface.RemoveChordPrecedenceRule
// (BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
// const class UInputMappingContext*       SourceIMC                                              (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void IEnhancedInputSubsystemInterface::RemoveChordPrecedenceRule(const class UInputMappingContext* SourceIMC)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("EnhancedInputSubsystemInterface", "RemoveChordPrecedenceRule");

	Params::EnhancedInputSubsystemInterface_RemoveChordPrecedenceRule Parms{};
