...
{
public:
	TArray<struct FScopeBuffSpecInfo>             BuffInfos;                                         // 0x1470(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<int32>                                 ScopeIDs;                                          // 0x1480(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
{
public:
	class AActor*                                 QuoteProjectile;                                   // 0x1B80(0x0008)(BlueprintVisible, Net, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
