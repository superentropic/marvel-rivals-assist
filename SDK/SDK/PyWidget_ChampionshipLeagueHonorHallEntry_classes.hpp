...
public:
	...
	TArray<class UTexture2D*>                     ImgRankBgList;                                     // 0x05D8(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVector2D                              CardSize;                                          // 0x05E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FLinearColor>                   ColorFirstHoveredVXList;                           // 0x05F8(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<struct FLinearColor>                   ColorSecondaryHoveredVXList;                       // 0x0608(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<struct FGuideTipsStyle>                GuideActions;                                      // 0x0618(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NativeAccessSpecifierPublic)
