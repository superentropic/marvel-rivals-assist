...
{
public:
	struct FSlateColor                            BtnTextColor_Normal;                               // 0x0610(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            BtnTextColor_Hovered;                              // 0x0624(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
