...
void AChaosCacheManager::ConfirmSetActorTickEnabled(bool bEnabled, bool bForce)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ChaosCacheManager", "ConfirmSetActorTickEnabled");

	Params::ChaosCacheManager_ConfirmSetActorTickEnabled Parms{};
...
// Function ChaosCaching.ChaosCacheManager.ResetAllRestCollectionState
// (Final, RequiredAPI, Native, Public, BlueprintCallable)

void AChaosCacheManager::ResetAllRestCollectionState()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ChaosCacheManager", "ResetAllRestCollectionState");
