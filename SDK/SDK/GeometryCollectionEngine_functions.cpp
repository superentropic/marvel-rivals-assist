...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// class UGeometryCollection*              RestCollectionIn                                       (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
int32 UGeometryCollection::GetNumRenderDataLODs() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GeometryCollection", "GetNumRenderDataLODs");

	Params::GeometryCollection_GetNumRenderDataLODs Parms{};
...
int32 UGeometryCollection::GetNumSecondaryRenderDataLODs() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GeometryCollection", "GetNumSecondaryRenderDataLODs");

	Params::GeometryCollection_GetNumSecondaryRenderDataLODs Parms{};
