...
{
public:
	class UMaterialInterface*                     SoulMaterial;                                      // 0x1340(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCurveVector*                           StartMaterialCurve;                                // 0x1348(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 MaterialNameXName;                                 // 0x1350(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 MaterialNameYName;                                 // 0x1360(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 MaterialNameZName;                                 // 0x1370(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<int32>                                 ExtraSoulHero;                                     // 0x1380(0x0010)(Edit, NativeAccessSpecifierPublic)
