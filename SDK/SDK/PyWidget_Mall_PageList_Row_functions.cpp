...
// PythonFunction PyWidget_Mall_PageList_Row.PyWidget_Mall_PageList_Row.Destruct
// (BlueprintCosmetic, Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyWidget_Mall_PageList_Row::Destruct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_Mall_PageList_Row", "Destruct");
