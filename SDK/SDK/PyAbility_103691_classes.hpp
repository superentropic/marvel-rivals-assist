...
public:
	...
	TMulticastInlineDelegate<void()>              SetMaterial;                                       // 0x1750(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
