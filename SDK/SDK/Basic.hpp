...
namespace Offsets
{
	// Dumper-7 offsets updated for 5.3.2-3870120+++depot_marvel+S10.0_release-Marvel.
	constexpr int32 GObjects          = 0x0F8FC870;
	constexpr int32 AppendString      = 0x00FA0FC0;
	constexpr int32 GNames            = 0x0F809D28;
	constexpr int32 GWorld            = 0x0FAA9DC8;
	constexpr int32 ProcessEvent      = 0x011A8580;
	constexpr int32 ProcessEventIdx   = 0x00000056;
}
