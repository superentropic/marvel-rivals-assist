...
// const struct FBondInstance&             InBond                                                 (ConstParm, Parm, OutParm, ReferenceParm)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

bool APyMarvelBondManager::PyCanAddCharacterToBond(class AMarvelBaseCharacter* InCharacter, const struct FBondInstance& InBond)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyMarvelBondManager", "PyCanAddCharacterToBond");

	Params::PyMarvelBondManager_PyCanAddCharacterToBond Parms{};
