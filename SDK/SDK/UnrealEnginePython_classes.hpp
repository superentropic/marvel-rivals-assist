...
// 0x0040 (0x0E00 - 0x0DC0)
class APyCharacter final : public ACharacter
{
public:
	class FString                                 PythonModule;                                      // 0x0DC0(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PythonClass;                                       // 0x0DD0(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PythonTickForceDisabled;                           // 0x0DE0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PythonDisableAutoBinding;                          // 0x0DE1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_DE2[0x1E];                                     // 0x0DE2(0x001E)(Fixing Struct Size After Last Property [ Dumper-7 ])
