...
void UPyWidget_SummonedHpBar::SetTargetActor(class AActor* InActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_SummonedHpBar", "SetTargetActor");

	Params::PyWidget_SummonedHpBar_SetTargetActor Parms{};
