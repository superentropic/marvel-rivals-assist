...
{
public:
	void AddChordPrecedenceRule(class UInputMappingContext* SourceIMC, class UInputMappingContext* PriorityIMC);
	...
	void RemoveChordPrecedenceRule(const class UInputMappingContext* SourceIMC);
...
public:
	...
	uint8                                         Pad_7F8[0x88];                                     // 0x07F8(0x0088)(Fixing Struct Size After Last Property [ Dumper-7 ])
