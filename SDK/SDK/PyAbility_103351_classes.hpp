...
// 0x0020 (0x2BB0 - 0x2B90)
class UPyAbility_103351 : public UMarvelAbility_AimDownSights
{
public:
	TMulticastInlineDelegate<void()>              OnAbilityCommit;                                   // 0x2B90(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnAbilityCancel;                                   // 0x2BA0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
