...
public:
	...
	TMulticastInlineDelegate<void(class UObject* Widget, bool Hovered)> OnAbstractTaskInfoHoverdChange; // 0x05D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
...
{
public:
	TArray<class UHeroSettlementData*>            ViewItemList;                                      // 0x05D8(0x0010)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FSoftClassPath                         AbstractInfoTips;                                  // 0x05E8(0x0028)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
