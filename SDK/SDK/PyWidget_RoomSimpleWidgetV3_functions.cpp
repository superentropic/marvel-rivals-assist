...
// PythonFunction PyWidget_RoomSimpleWidgetV3.PyWidgetNavigationBarRoomID.OnInitialized
// (BlueprintCosmetic, Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyWidgetNavigationBarRoomID::OnInitialized()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidgetNavigationBarRoomID", "OnInitialized");
...
// PythonFunction PyWidget_RoomSimpleWidgetV3.PyWidgetNavigationBarRoomID.Construct
// (BlueprintCosmetic, Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyWidgetNavigationBarRoomID::Construct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidgetNavigationBarRoomID", "Construct");
