...
class FString UIpConnection::LowLevelGetRemoteAddress(bool bAppendPort)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("IpConnection", "LowLevelGetRemoteAddress");

	Params::IpConnection_LowLevelGetRemoteAddress Parms{};
