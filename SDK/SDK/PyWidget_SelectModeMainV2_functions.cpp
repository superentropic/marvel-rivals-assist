...
// Parameters:
// class UObject*                          FontMaterial                                           (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UPyWidget_SelectModeMainV2::OnSoftMaterialLoad(class UObject* FontMaterial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_SelectModeMainV2", "OnSoftMaterialLoad");

	Params::PyWidget_SelectModeMainV2_OnSoftMaterialLoad Parms{};
