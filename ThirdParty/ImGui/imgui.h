...
namespace ImGui
{
    ...
    //    BeginPopup/EndPopup, etc. where the EndXXX call should only be called if the corresponding BeginXXX function
    //    returned true. Begin and BeginChild are the only odd ones out. Will be fixed in a future update.]
    IMGUI_API bool          BeginChild(bool style, const char* str_id, const char* icon, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);

    IMGUI_API bool          NewBeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);


    IMGUI_API bool          BeginChild(bool style, ImGuiID id, const char* icon, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    IMGUI_API void          EndChild(bool style = false);
    ...
    IMGUI_API void          TextColoredWishFont(ImFont* font, const ImVec4& col, const char* fmt, ...)            IM_FMTARGS(2); // shortcut for PushStyleColor(ImGuiCol_Text, col); Text(fmt, ...); PopStyleColor();
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0),bool showbg = true);   // button
    IMGUI_API bool          NewButton(const char* label, const ImVec2& size = ImVec2(0, 0), const char* icon = "");   // button
    ...
    IMGUI_API void          CheckboxWishTips(const char* label, bool* v, const char* text);
    IMGUI_API bool          Checkbox_hitbox(const char* label, bool* v);
    IMGUI_API bool          Checkbox6(const char* label, bool* v);
    IMGUI_API bool          Hive_Checkbox(ImTextureID image, const char* label, bool v, const ImVec2& size_arg, float sizeve, const ImVec2& mousePos, const ImVec2& labelPos);
    IMGUI_API bool          Hive_Checkbox_Radio(ImTextureID image, const char* label, int* v, int v_button, const ImVec2& size_arg, float sizeve, const ImVec2& mousePos, const ImVec2& labelPos);

    IMGUI_API void          Pickerbox(const char* label, bool* v, float col[3], ImGuiColorEditFlags flags = 0);

    IMGUI_API void          Pickerbox2(const char* label, bool* v, float color[4], int colCount, float colors[][4], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          colorpicker_button(ImFont* font, const char* tips, const char* label, const ImVec2& size_arg, bool* callback);
    IMGUI_API bool          Item_checkbox(const ImVec2& image_size, ImTextureID image, const char* label, bool* v, const ImVec2& size_arg, int lv);
    ...
    IMGUI_API bool          BeginCombo_popup(const char* label, const char* preview_value, int val, bool multi = false, ImGuiComboFlags flags = 0);
    IMGUI_API bool          Combo_popup(const char* label, int* current_item, const char* const items[], int items_count, int popup_max_height_in_items = -1);
    IMGUI_API bool          Combo_popup(const char* label, int* current_item, const char* items_separated_by_zeros, int popup_max_height_in_items = -1);      // Separate items with \0 within a string, end item-list with \0\0. e.g. "One\0Two\0Three\0"
    IMGUI_API bool          Combo_popup(const char* label, int* current_item, const char* (*getter)(void* user_data, int idx), void* user_data, int items_count, int popup_max_height_in_items = -1);
    ...
    IMGUI_API bool          SliderFloat1(const char* label, float* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0, bool search_enable = true);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
    ...
    IMGUI_API bool          SliderInt1(const char* label, int* v, int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0, bool search_enable = true);

    IMGUI_API bool          SliderInt2(const char* label, int v[2], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt3(const char* label, int v[3], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt4(const char* label, int v[4], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderScalar1(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          SliderScalar_popup(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt_popup(const char* label, int* v, int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderScalarF_popup(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderFloat_popup(const char* label, float* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.


    IMGUI_API bool          NewInputTextEx(const char* label, const char* description, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    ...
    IMGUI_API bool          ColorEdit5(const char* label, float col[4], ImGuiColorEditFlags flags = 0);
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddGlitchText(const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL);
    IMGUI_API void  AddGlitchText(const ImFont* font, float font_size, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = NULL);
