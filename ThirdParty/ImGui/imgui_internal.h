...
//#endif
    ...
    IMGUI_API bool          NewItemHoverable(const ImRect& bb, ImGuiID id);
    ...
    IMGUI_API bool          ItemHoverable1(const ImRect& bb, ImGuiID id);
    ...
    IMGUI_API bool          BeginChildEx(bool style, const char* name, const char* icon, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    IMGUI_API bool          BeginChildEx1(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    IMGUI_API void          RenderScrollingGradients(const ImRect& rect, float thickness);
    ...
    IMGUI_API bool          Keybind(const char* label, int* key, bool showlabel = true);
    
    IMGUI_API void           RenderTextColor(ImFont* font, const ImVec2& p_min, const ImVec2& p_max, ImU32 col, const char* text, const ImVec2& align);
    IMGUI_API void           TextColoredWrapped(const char* label, ImU32 color, float wrap_size);

    IMGUI_API bool           BeginPopupW(const char* id, const char* hint);
    IMGUI_API void           EndPopupW();

    // Widgets
    IMGUI_API bool          color_butto2n(const char* name, ImVec2 size, ImU32 color_bg, int sp = 0);
    IMGUI_API void          DrawFoldedRectangle(ImDrawList* draw_list, ImVec2 position, ImVec2 size, ImU32 color, ImU32 trianglecolor, int down = 15, int arrow = 1);
    IMGUI_API void          DrawVerticalHexagon(ImDrawList* draw_list, ImVec2 center, float size, ImU32 color);

    IMGUI_API bool          icon_box(ImFont* font, const char* icon, ImVec2 size, ImU32 color_bg, ImU32 color_icon, ImU32 color_border);
    IMGUI_API bool          color_button(const char* name, ImVec2 size, ImU32 color_bg);
    void icon_box(ImTextureID id, ImVec2 size, ImU32 color_icon);
    bool Tab1(bool selectable, const char* label, const ImVec2& size_arg);
    bool Tab(bool selectable, const char* label, const ImVec2& size_arg);
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0);
    IMGUI_API bool          Tabs(bool selected, const char* icon, const char* label);
    IMGUI_API bool          SubTabs(ImFont* font, bool selected, const char* label, const ImVec2& size_arg);
    
    IMGUI_API bool          NewButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, const char* icon = "");


    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, bool showbg = true);
    ...
    IMGUI_API bool          Button_iconEx(const char* icon, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Button_icon(const char* icon, const char* label, const ImVec2& size_arg = ImVec2(0, 0));
    ...
    IMGUI_API bool          ButtonBehavior1(const ImRect& bb, ImGuiID id, bool* out_hovered, bool* out_held, ImGuiButtonFlags flags = 0);
    ...
    // InputText
    IMGUI_API bool          InputTextEx1(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
