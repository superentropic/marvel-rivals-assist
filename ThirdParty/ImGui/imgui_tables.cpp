...
bool    ImGui::BeginTableEx(const char* name, ImGuiID id, int columns_count, ImGuiTableFlags flags, const ImVec2& outer_size, float inner_width)
{
    ...
    if (use_child_window)
    {
        ...
        BeginChildEx(false,name,"o", instance_id, outer_rect.GetSize(), false, child_flags);
    ...
    table->BorderColorStrong = GetColorU32(c::text::text,0.2f);
    table->BorderColorLight = GetColorU32(c::text::text, 0.2f);
